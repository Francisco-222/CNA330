...
def main():
    ...
    while(1):  # Infinite Loops
        ...
        time.sleep(3600)  # Sleep for 1h. Ran every hour because API have request limits.
# To test script if works change time.sleep() to different seconds delete your table in MySQL///by FRANCISCO
